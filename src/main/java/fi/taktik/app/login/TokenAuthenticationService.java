...
public class TokenAuthenticationService {
    ...
    static final String SECRET = "asecret";
    static final String TOKEN_PREFIX = "Bearer";
    static final String HEADER_STRING = "Authorization";

    /**
     * Creates the authenticationtoken for response header.
     *
    ...
    /**
     * Checks authentication from request header.
     *
     * @param request http request.
     * @return token if auth is right.
     */
